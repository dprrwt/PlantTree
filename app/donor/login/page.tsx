...
import { loginDonor, type DonorLoginState } from "./actions";

const initialState: DonorLoginState = { error: null };
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Accounts are created automatically when the operator verifies your
          donation. If you&apos;ve donated and haven&apos;t yet set a password,
          check your inbox for a setup email.
        </p>
